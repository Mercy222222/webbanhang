...
<section style="margin-bottom: 5rem;">
    <div style="background: linear-gradient(135deg, #0f172a 0%, var(--surface) 100%); border: 1px solid var(--border); padding: 5rem 3rem; border-radius: var(--radius-lg); text-align: center; margin-bottom: 4rem;">
        ...
        <p style="font-size: 1.15rem; max-width: 700px; margin: 0 auto; color: var(--text-muted); line-height: 1.6;">Chúng tôi luôn sẵn sàng hỗ trợ bạn. Tìm hiểu các hướng dẫn mua sắm, chính sách bảo hành chính hãng và chính sách đổi trả sản phẩm dễ dàng tại GEARVN dưới đây.</p>
    </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 4rem;">
            ...
            <div id="huong-dan" style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-lg); padding: 3rem;">
                ...
                <div style="color: var(--text-muted); line-height: 1.8; font-size: 0.95rem; display: flex; flex-direction: column; gap: 1rem;">
                    ...
                    <p><b>Bước 4: Xác nhận đơn hàng</b> - Nhấp nút <b>Xác nhận đặt hàng</b>. Đơn hàng của bạn sẽ được lưu vào hệ thống ở trạng thái Chờ xử lý (`pending`), nhân viên GEARVN sẽ liên hệ xác nhận và giao hàng nhanh nhất.</p>
                </div>
            </div>
            ...
            <div id="bao-hanh" style="background: var(--surface); border: 1px solid var(--border); border-radius: var(--radius-lg); padding: 3rem;">
                ...
                <div style="color: var(--text-muted); line-height: 1.8; font-size: 0.95rem; display: flex; flex-direction: column; gap: 1rem;">
                    <p>Mọi thiết bị laptop gaming (ASUS ROG, Acer Predator, MSI) và PC lắp ráp mua tại GEARVN đều được hưởng gói **Bảo hành chính hãng 24 tháng** kể từ ngày mua hàng.</p>
                    <p>Đối với các sản phẩm Gaming Gear như bàn phím cơ ASUS ROG, chuột Logitech G và tai nghe Razer, thời gian bảo hành sẽ là từ **12 - 24 tháng** theo chính sách lỗi 1 đổi 1 của nhà phân phối trong vòng 30 ngày đầu tiên nếu phát sinh lỗi phần cứng từ nhà sản xuất.</p>
