...
3. Drag & drop or browse to select the following files from the root of this project:
   * 📁 [GearVN_API.postman_collection.json](file:///c:/webbanhang/GearVN_API.postman_collection.json) — *Contains the RESTful requests.*
   * 📁 [GearVN_API.postman_environment.json](file:///c:/webbanhang/GearVN_API.postman_environment.json) — *Contains environment configuration (e.g., base URL).*
