import { createAgent, type AgentRouteHandler, defineAgentProfile } from '@flue/runtime';
// @ts-ignore - The sandbox module path may vary based on exact Flue structure
...
export default createAgent(() => ({
  ...
  tools: [fileReaderTool as any],
  skills: [codeReviewSkill as any],
